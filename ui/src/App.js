                  ...
                  {({
                    ...
                    return (
                      <div {...getRootProps()}>
                        ...
                        {!isDragActive && (
                          <div>
                            Or upload a CSV by clicking or dropping it{" "}
                            <font color="#0000EE">here</font> (max 5mb)
                          </div>
                        )}
                        {isDragActive &&
                          !isDragReject &&
          ...
          if (result !== "" && Object.keys(result["columns_ml"]).length !== 0) {
            return (
              <div className="results_content">
                <Row>
                  <Col>
                    <h3>Identified Columns (ML Based)</h3>
                  </Col>
                </Row>
                <Row>
                  <Col>
              ...
              <Row>
                <Col>
                  ...
                  <ol>
                    ...
                    <li>
                      <b>Supervised Learning (In progress)</b>: manually tagging
